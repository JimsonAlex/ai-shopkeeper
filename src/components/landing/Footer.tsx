    ...
    <div className="container mx-auto px-4 md:px-8">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12 mb-16">
        <div className="col-span-2 md:col-span-2">
          ...
          <p className="text-primary-foreground/50 text-sm mt-5 max-w-xs leading-relaxed">
            AI-powered accounting for chaotic retail. Record sales your way — the AI handles the rest.
          </p>
        </div>
        <div>
          <h4 className="font-display font-bold text-primary-foreground/70 text-[11px] uppercase tracking-[0.15em] mb-6">Product</h4>
        ...
        <div>
          <h4 className="font-display font-bold text-primary-foreground/70 text-[11px] uppercase tracking-[0.15em] mb-6">Company</h4>
          <ul className="space-y-4 text-sm text-primary-foreground/50">
      ...
      <div className="border-t border-primary-foreground/10 pt-10 text-center text-xs text-primary-foreground/40 tracking-wide">
